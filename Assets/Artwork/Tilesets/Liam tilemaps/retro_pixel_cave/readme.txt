...
Hello! Thank you for purchasing the Retro Pixel Cave tileset. Here are a few pointers to help you navigate and make sense of this zip file.

- There are six tileset styles. In the root folder, you'll see each style has its own folder.
...
- Pretty much every object and tile is a size multiple of 4x4 pixels. They're made to stick to a 4x4 or 8x8 grid, but you don't necessarily have to stick to a grid if you don't want to.
